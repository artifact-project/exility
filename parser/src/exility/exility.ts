...
const COLON_CODE = utils.COLON_CODE; // ":"
...
const PSEUDO_ELEMENT = 'pseudo';
const PSEUDO_ELEMENT_AWAIT = 'pseudo_await';
...
export default <SkeletikParser>skeletik({
	...
	'': {
		...
		'}': closeGroup,
		'$name': '!' + ENTRY,
		'$id_or_class': (lex: Lexer, parent: Bone): string | [Bone, string] => {
